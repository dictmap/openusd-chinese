...
## 当前真实状态
- 全量页面：406
- 完整双语 / good_bilingual：237
- 严格中文可读 / review_ready_zh：174
- API complete：111
- API review_ready_zh：51
- Release complete：126
- Release review_ready_zh：123
- 未完整翻译草稿 / bilingual_draft：169
- draft_needs_translation：159
- draft_template_only：10
- pending_full_scope：0
- promotion manifest：229 项
...
- API complete / review_ready_zh：111 / 51
...
建议目标：`下一轮建议 PromotionRound：沿 OpenExec 点击路径继续检查 Exec/Esf/EsfUsd 等仍为 bilingual_draft 且有 source snapshot 的页面。`。如果该页无法达到 `good_bilingual`，停止并报告阻塞；不要重复处理 `full_site/api/md_pxr_exec_vdf__r_e_a_d_m_e.html` 或 release 已完成页。
