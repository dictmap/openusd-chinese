...
- 全量页面：406
- 完整双语 / good_bilingual：100
- 严格中文可读 / review_ready_zh：37
- API complete：72
- Release complete：28
- 未完整翻译草稿 / bilingual_draft：306
- draft_needs_translation：295
- draft_template_only：11
- pending_full_scope：0
- promotion manifest：92 页
...
- 官方页面：`https://openusd.org/release/user_guides/schemas/usdLux/SphereLight.html`
- 完成数状态：good_bilingual=100；review_ready_zh=37。
...
- Release complete / review_ready_zh：28 / 25
...
建议目标：`full_site/release/user_guides/schemas/usdLux/CylinderLight.html`。如果该页无法达到 `good_bilingual`，停止并报告阻塞；不要回到只刷 API 模块页的节奏。
