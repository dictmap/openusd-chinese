...
- 全量页面：406
- 完整双语 / good_bilingual：104
- 严格中文可读 / review_ready_zh：41
- API complete：72
- Release complete：32
- 未完整翻译草稿 / bilingual_draft：302
- draft_needs_translation：291
- draft_template_only：11
- pending_full_scope：0
- promotion manifest：96 项
...
- 官方页面：`https://openusd.org/release/user_guides/schemas/usdLux/DomeLight.html`
- 完成数状态：good_bilingual=104；review_ready_zh=41。
...
- Release complete / review_ready_zh：32 / 29
...
建议目标：`full_site/release/user_guides/schemas/usdLux/DomeLight_1.html`。如果该页无法达到 `good_bilingual`，停止并报告阻塞；不要回到只刷 API 模块页的节奏。
