...
## 当前真实状态
- 全量页面：406
- 完整双语 / good_bilingual：214
- 严格中文可读 / review_ready_zh：151
- API complete：88
- API review_ready_zh：28
- Release complete：126
- Release review_ready_zh：123
- 未完整翻译草稿 / bilingual_draft：192
- draft_needs_translation：182
- draft_template_only：10
- pending_full_scope：0
- promotion manifest：206 项
...
- API complete / review_ready_zh：88 / 28
...
建议目标：`full_site/api/hd_storm_page_front.html`。如果该页无法达到 `good_bilingual`，停止并报告阻塞；不要重复处理 `full_site/api/trace_page_front.html` 或 release 已完成页。
