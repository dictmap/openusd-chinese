...
## 当前真实状态
- 全量页面：406
- 完整双语 / good_bilingual：245
- 严格中文可读 / review_ready_zh：182
- API complete：119
- API review_ready_zh：59
- Release complete：126
- Release review_ready_zh：123
- 未完整翻译草稿 / bilingual_draft：161
- draft_needs_translation：151
- draft_template_only：10
- pending_full_scope：0
- promotion manifest：237 项
...
- API complete / review_ready_zh：119 / 59
...
建议目标：`下一轮建议 PromotionRound：基于 live reports 选择一个仍为 bilingual_draft 且有 source snapshot 的 API 高价值页面。`。如果该页无法达到 `good_bilingual`，停止并报告阻塞；不要重复处理 `full_site/api/usd_semantics_overview.html` 或 release 已完成页。
