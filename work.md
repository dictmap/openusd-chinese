...
- 全量页面：406
- 完整双语 / good_bilingual：88
- 严格中文可读 / review_ready_zh：25
- API complete：72
- Release complete：16
- 未完整翻译草稿 / bilingual_draft：318
- draft_needs_translation：307
- draft_template_only：11
- pending_full_scope：0
- promotion manifest：80 页
...
## 第 385 轮：PromotionRound

- 轮次性质：页面晋级，exactly 1 个目标页。
- 本轮目标：`full_site/release/tut_generating_new_schema.html`
- 官方页面：`https://openusd.org/release/tut_generating_new_schema.html`
- 完成数状态：good_bilingual=88；review_ready_zh=25。
...
- Release complete / review_ready_zh：16 / 13
...
建议目标：`full_site/release/tut_usdview_plugin.html`。如果该页无法达到 `good_bilingual`，停止并报告阻塞；不要回到只刷 API 模块页的节奏。
