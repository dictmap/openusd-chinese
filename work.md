...
- 全量页面：406
- 完整双语 / good_bilingual：96
- 严格中文可读 / review_ready_zh：33
- API complete：72
- Release complete：24
- 未完整翻译草稿 / bilingual_draft：310
- draft_needs_translation：299
- draft_template_only：11
- pending_full_scope：0
- promotion manifest：88 页
...
- 官方页面：`https://openusd.org/release/user_guides/schemas/usdLux/PortalLight.html`
- 完成数状态：good_bilingual=96；review_ready_zh=33。
...
- Release complete / review_ready_zh：24 / 21
...
建议目标：`full_site/release/user_guides/schemas/usdLux/RectLight.html`。如果该页无法达到 `good_bilingual`，停止并报告阻塞；不要回到只刷 API 模块页的节奏。
