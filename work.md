...
## 当前真实状态
- 全量页面：406
- 完整双语 / good_bilingual：235
- 严格中文可读 / review_ready_zh：172
- API complete：109
- API review_ready_zh：49
- Release complete：126
- Release review_ready_zh：123
- 未完整翻译草稿 / bilingual_draft：171
- draft_needs_translation：161
- draft_template_only：10
- pending_full_scope：0
- promotion manifest：227 项
...
- API complete / review_ready_zh：109 / 49
...
建议目标：`下一轮建议 PromotionRound：重新读取 inventory 后选择一个仍为 bilingual_draft 且有 source snapshot 的高价值 API 页面。`。如果该页无法达到 `good_bilingual`，停止并报告阻塞；不要重复处理 `full_site/api/page__execution__system__design.html` 或 release 已完成页。
