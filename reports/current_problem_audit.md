...
Generated: 2026-06-07T17:44:08.123Z
...
| `P1-release-coverage-lag` | P1 | Completion remains API-skewed while release/tutorial/user-guide pages lag, although rounds 375 through 386 moved twelve release tutorials forward. | After several API PromotionRounds, choose a release/tutorial/user-guide page unless a named P0/P1 defect blocks the run. |
...
Prefer full_site/release/tut_converting_between_layer_formats.html for the next release/tutorial PromotionRound; otherwise stop and report the blocker.
