...
Generated: 2026-06-08T17:01:35.504Z
...
- target：`full_site/api/usddraco_page_front.html`
...
| --- | --- | --- | --- |
| `P0-api-draft-backlog` | P0 | 当前 good_bilingual=222/406，API complete=96，仍有 184 个可检查草稿。 | 继续推进 API 草稿；只把真实达到中文主阅读路径和 source parity 的页面写入 promotion manifest。 |
