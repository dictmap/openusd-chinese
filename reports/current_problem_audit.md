...
Generated: 2026-06-08T18:52:47.671Z
...
- promotion manifest：218
- api_complete：100
- api_review_ready_zh：40
...
- target：`full_site/api/classpxr__tsl_1_1robin__map.html`
...
| --- | --- | --- | --- |
| `P0-api-draft-backlog` | P0 | 当前 good_bilingual=226/406，API complete=100，仍有 180 个可检查草稿，不是完整翻译。 | 继续推进 API 草稿；只把真实达到中文主阅读路径和 source parity 的页面写入 promotion manifest。 |
| `P1-class-reference-source-parity` | P1 | 类参考页必须保留 Doxygen 分组、模板参数、typedef、函数名、属性名和链接语义，不能只写泛泛导读。 | 后续 class/struct 页面继续按 source snapshot 抽取官方分组，中文说明用途和边界，API 名保持原样。 |
