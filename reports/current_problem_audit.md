...
Generated: 2026-06-08T09:48:22.774Z
...
- target：`full_site/api/usd_physics_page_front.html`
...
| --- | --- | --- | --- |
| `P0-api-draft-backlog` | P0 | 当前 good_bilingual=203/406，API complete=77，仍有 203 个可检查草稿，不是完整翻译。 | 继续按 PromotionRound 或 DomainSprintRound 推进 API 草稿，只把达标页面写入 promotion manifest。 |
...
下一轮建议目标：`full_site/api/usd_proc_page_front.html`。开始前继续核对 git、报告、validation、Markdown 编码和 reading-flow；如果该页源页或验证阻塞，停止并报告具体原因。
