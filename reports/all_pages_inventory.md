...
Generated: 2026-06-07T10:07:46.672Z
...
- Release pages: 126
- API pages: 280
- Bilingual complete pages: 62
- Promoted complete pages: 54
- Bilingual draft pages: 344
...
| api | bilingual_draft | 开发者指南 / Developer Guides | full_site/api/_developer__guides.html | https://openusd.org/release/api/_developer__guides.html |
...
| api | bilingual_draft | Ar：资产解析 / Ar: Asset Resolution | full_site/api/ar_page_front.html | https://openusd.org/release/api/ar_page_front.html |
...
| api | bilingual_complete | https://openusd.org/release/api/class_hd_render_buffer.html | full_site/api/class_hd_render_buffer.html | https://openusd.org/release/api/class_hd_render_buffer.html |
...
| api | bilingual_complete | https://openusd.org/release/api/class_hd_st_dispatch_buffer.html | full_site/api/class_hd_st_dispatch_buffer.html | https://openusd.org/release/api/class_hd_st_dispatch_buffer.html |
| api | bilingual_complete | https://openusd.org/release/api/class_hd_st_render_pass_state.html | full_site/api/class_hd_st_render_pass_state.html | https://openusd.org/release/api/class_hd_st_render_pass_state.html |
...
| api | bilingual_complete | https://openusd.org/release/api/class_hdx_pick_from_render_buffer_task.html | full_site/api/class_hdx_pick_from_render_buffer_task.html | https://openusd.org/release/api/class_hdx_pick_from_render_buffer_task.html |
| api | bilingual_complete | https://openusd.org/release/api/class_hgi_g_l_graphics_cmds.html | full_site/api/class_hgi_g_l_graphics_cmds.html | https://openusd.org/release/api/class_hgi_g_l_graphics_cmds.html |
...
| api | bilingual_complete | https://openusd.org/release/api/class_sdf_usdz_file_format.html | full_site/api/class_sdf_usdz_file_format.html | https://openusd.org/release/api/class_sdf_usdz_file_format.html |
...
| api | bilingual_complete | https://openusd.org/release/api/class_tf_dense_hash_map.html | full_site/api/class_tf_dense_hash_map.html | https://openusd.org/release/api/class_tf_dense_hash_map.html |
| api | bilingual_complete | https://openusd.org/release/api/class_tf_py_lock.html | full_site/api/class_tf_py_lock.html | https://openusd.org/release/api/class_tf_py_lock.html |
...
| api | bilingual_draft | API 页面草稿：hf Directory / hf Directory | full_site/api/dir_aa3bf17f9d6f68169ce0fa9df97655e9.html | https://openusd.org/release/api/dir_aa3bf17f9d6f68169ce0fa9df97655e9.html |
| api | bilingual_draft | API 页面草稿：executorInvalidationData.h File / executorInvalidationData.h File | full_site/api/executor_invalidation_data_8h.html | https://openusd.org/release/api/executor_invalidation_data_8h.html |
...
| api | bilingual_draft | API 模块草稿：Glf: Utility classes for OpenGL / Glf: Utility classes for OpenGL | full_site/api/glf_page_front.html | https://openusd.org/release/api/glf_page_front.html |
...
| api | bilingual_draft | API 模块草稿：Hd : The Hydra Framework / Hd : The Hydra Framework | full_site/api/hd_page_front.html | https://openusd.org/release/api/hd_page_front.html |
...
| api | bilingual_draft | API 页面草稿：OpenExec Overview / OpenExec Overview | full_site/api/md_pxr_exec_exec_usd_docs_overview.html | https://openusd.org/release/api/md_pxr_exec_exec_usd_docs_overview.html |
...
| api | bilingual_draft | API 页面草稿：Boolean Expressions / Boolean Expressions | full_site/api/md_pxr_usd_sdf_doxygen_boolean_expressions.html | https://openusd.org/release/api/md_pxr_usd_sdf_doxygen_boolean_expressions.html |
| api | bilingual_draft | API 页面草稿：Validation / Validation | full_site/api/md_pxr_usd_validation_usd_validation__r_e_a_d_m_e.html | https://openusd.org/release/api/md_pxr_usd_validation_usd_validation__r_e_a_d_m_e.html |
...
| api | bilingual_draft | 结构体参考草稿：HgiSamplerDesc Struct / HgiSamplerDesc Struct | full_site/api/struct_hgi_sampler_desc.html | https://openusd.org/release/api/struct_hgi_sampler_desc.html |
